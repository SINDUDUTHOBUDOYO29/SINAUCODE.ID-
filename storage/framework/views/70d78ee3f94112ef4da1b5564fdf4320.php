        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo e(url('kategoris/'.$item->id)); ?>" method="post">
                    ...
                    <?php echo csrf_field(); ?>
                    <div class="mb-3">
                        <p>Are you sure want to delete kategor with, name<?php echo e($item->name); ?>, delete..?</p>
                    </div>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH C:\laragon\www\sinaucode\resources\views/back/kategori/delete_modal.blade.php ENDPATH**/ ?>